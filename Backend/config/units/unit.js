export default class Unit {
    ...
    damageVersus(enemy) {
        ...
        switch (enemy.unittype) {
            case 1:
                return [
                    this.dmgversusleichterjaeger,
                    this.rapidfirevsleichterjaeger,
                ];
            case 2:
                return [
                    this.dmgversusschwererjaeger,
                    this.rapidfirevsschwererjaeger,
                ];
            case 3:
            ...
            case 6:
                return [
                    this.dmgversusminingdrohne,
                    this.rapidfirevsminingdrohne,
                ];
            case 7:
                return [
            ...
            case 10:
                return [
                    this.dmgversusflugdeckkreuzer,
                    this.rapidfirevsflugdeckkreuzer,
                ];
            case 11:
                return [
                    this.dmgversuskolonieschiff,
                    this.rapidfirevskolonieschiff,
                ];
            case 12:
                return [
                    this.dmgversusbergbauschiff,
                    this.rapidfirevsbergbauschiff,
                ];
            case 13:
                return [
                    this.dmgversusschlachtschiff,
                    this.rapidfirevsschlachtschiff,
                ];
            case 14:
                return [
                    this.dmgversusschlachtkreuzer,
                    this.rapidfirevsschlachtkreuzer,
                ];
            case 15:
                return [
                    this.dmgversustraegerschiff,
                    this.rapidfirevstraegerschiff,
                ];
            case 16:
                return [
                    this.dmgversusflakgeschütz,
                    this.rapidfirevsflakgeschütz,
                ];
            case 17:
            ...
            case 19:
                return [
                    this.dmgversuslasergeschütz,
                    this.rapidfirevslasergeschütz,
                ];
            case 20:
                return [this.dmgversusrailgun, this.rapidfirevsrailgun];
            case 21:
                return [
                    this.dmgversuspartikelkanone,
                    this.rapidfirevspartikelkanone,
                ];
            case 22:
                return [
